  ...
  return (
    <div className="row p-6 main-wrap">
      <article className="title px-1">
        {/* <h1>
          Hello I'm <br />
          <span>Tanawan Wongsawadee</span>
        </h1> */}
        <h1>
          <Typed string="Hello I'm <br/>Tanawan Wongsawadee" speed={300}  />
        </h1>
        <p>
        ...
        <div className="row">
          <div className="skill">
            ...
            <p>PHP</p>
            <div className="progress">
              <div className="inside" style={{ width: "80%" }}>
                80%
              </div>
            </div>
            <p>JS</p>
            ...
            <p>NODEJS</p>
            <div className="progress">
              <div className="inside" style={{ width: "70%" }}>
                70%
              </div>
            </div>
          </div>
